...
var ts_results_1 = __nccwpck_require__(4616);
var util_1 = __nccwpck_require__(2566);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.traceAsyncErrors = exports.delay = exports.isExactType = void 0;
...
exports.delay = delay;
var traceAsyncErrors = function (fn) { return __awaiter(void 0, void 0, void 0, function () {
    var startStack, error_1;
...
exports.traceAsyncErrors = traceAsyncErrors;
...
(function (factory) {
    ...
    tslib_1.__exportStar(__nccwpck_require__(8034), exports);
});
//# sourceMappingURL=index.js.map
...
(function (factory) {
    ...
    var utils_1 = __nccwpck_require__(1748);
    var result_1 = __nccwpck_require__(5618);
    /**
...
(function (factory) {
    ...
    var utils_1 = __nccwpck_require__(1748);
    var option_1 = __nccwpck_require__(8034);
    /**
...
var helper = __nccwpck_require__(9585);
...
var queues = __nccwpck_require__(5705);

var events = __nccwpck_require__(193);
...
var fetch = __nccwpck_require__(2340);

var FormData = __nccwpck_require__(6612);
...
var _zuliprc = _interopRequireDefault(__nccwpck_require__(6836));
...
var api = __nccwpck_require__(7992);

var accounts = __nccwpck_require__(8386);

var streams = __nccwpck_require__(5253);

var messages = __nccwpck_require__(1563);

var queues = __nccwpck_require__(5705);

var events = __nccwpck_require__(193);

var users = __nccwpck_require__(345);

var emojis = __nccwpck_require__(2116);

var typing = __nccwpck_require__(6580);

var reactions = __nccwpck_require__(1755);

var server = __nccwpck_require__(8618);

var filters = __nccwpck_require__(3612);

var eventsWapper = __nccwpck_require__(9410);
...
var _ini = __nccwpck_require__(8885);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __nccwpck_require__(2186);
const ts_results_1 = __nccwpck_require__(4616);
const ts_async_results_1 = __nccwpck_require__(9770);
const zulip_js_1 = __importDefault(__nccwpck_require__(1917));
var DestinationKind;
...
function getMandatoryInputFromJob(key) {
    const candidate = (0, core_1.getInput)(key, { required: true });
    return candidate
        ? new ts_results_1.Ok(candidate)
        : new ts_results_1.Err(`input "${key}" must be provided and non-empty`);
}
function getDestinationKindInputFromJob() {
    ...
    return getMandatoryInputFromJob("type")
        ...
        return validValues.includes(input)
            ? new ts_results_1.Ok(input)
            : new ts_results_1.Err(errorMessage);
    });
}
...
async function getZulipClient() {
    return new ts_async_results_1.AsyncResultWrapper(ts_results_1.Result.all(getMandatoryInputFromJob("api-key"), getMandatoryInputFromJob("email"), getMandatoryInputFromJob("organization-url")))
        .flatMap(([apiKey, username, realm]) => new ts_async_results_1.AsyncResultWrapper(ts_results_1.Result.wrapAsync(async () => (0, zulip_js_1.default)({
        apiKey,
        username,
        realm,
    }))))
...
async function postMessageFromJobInputs() {
    const topic = (0, core_1.getInput)("topic", { required: false });
    return new ts_async_results_1.AsyncResultWrapper(ts_results_1.Result.all(getMandatoryInputFromJob("content"), getDestinationDetails(), await getZulipClient()))
        ...
        return new ts_async_results_1.AsyncResultWrapper(ts_results_1.Result.wrapAsync(async () => client.messages.send(parameters)));
    })
        .flatMap((response) => {
        return response.result === "success"
            ? new ts_results_1.Ok(`Message successfully sent with id: ${response.id}`)
            : new ts_results_1.Err(response.code
...
postMessageFromJobInputs().then((result) => {
    if (result.ok) {
        (0, core_1.info)(result.val);
    }
    else {
        (0, core_1.setFailed)(result.val);
    }
});
...
var arrayWithHoles = __nccwpck_require__(4358);
var iterableToArrayLimit = __nccwpck_require__(4527);
var unsupportedIterableToArray = __nccwpck_require__(7361);
var nonIterableRest = __nccwpck_require__(8768);
